...
template <typename _T>
class __future<sycl_iterator<sycl::access::mode::read_write, _T, sycl_buffer_allocator(_T)>>
    : public __par_backend_hetero::__future_base
{
    using _Tp = sycl_iterator<sycl::access::mode::read_write, _T, sycl_buffer_allocator(_T)>;
    _Tp __data;
